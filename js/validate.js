...
function Validator(formSelection) {
  ...
  var validatorRules = {
    ...
    numberPhone: function (value) {
      const regexNum = /^[0-9]*$/;
      return regexNum.test(value) && value.length == 10
        ? undefined
        : "Nhập đúng số điện thoại";
    },
    numberCoures: function (value) {
      const regexNum = /^[0-9]*$/;
      return regexNum.test(value) && value <= 10
        ? undefined
        : "Nhập số điểm 0-10";
    },
    onlyNumber: function (value) {
      const regexNum = /^[0-9]*$/;
      return regexNum.test(value) ? undefined : "Chỉ nhập số";
    },
